...
Shared across LeftSidebarNav (sidebar entry icon) and GitHubImportModal (embedded header) to avoid duplicating the raw octocat SVG path; keep the same rendered output (viewBox 0 0 24 24, currentColor fill, aria-hidden).
*/
export function GithubIcon({ size = 16, ...props }: LucideProps) {
  return (
